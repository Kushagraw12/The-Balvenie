...
class Header extends React.Component {
  ...
  renderSearch = () => {
    ...
    return (
      <Input
        ...
        // onFocus={() => navigation.navigate('Columns')}
  ...
  renderTabs = () => {
    ...
    return (
      <Block row style={styles.tabs}>
        <Button shadowless style={[styles.tab, styles.divider]} onPress={() => navigation.navigate('Columns')}>
          <Block row middle>
            <Icon name="grid" family="feather" style={{ paddingRight: 8 }} />
            <Text size={16} style={styles.tabTitle}>{tabTitleLeft || 'Columns'}</Text>
          </Block>
        </Button>
        <Button shadowless style={styles.tab} onPress={() => navigation.navigate('Calculator')}>
          <Block row middle>
            <Icon size={16} name="camera-18" family="GalioExtra" style={{ paddingRight: 8 }} />
            <Text size={16} style={styles.tabTitle}>{tabTitleRight || 'Calculator'}</Text>
          </Block>
        </Button>
      </Block>
    )
  ...
  renderHeader = () => {
    ...
    if (search || tabs) {
      return (
        <Block center style={styles.head}>
...
const styles = StyleSheet.create({
  ...
  navbar: {
    ...
    paddingTop: iPhoneX ? theme.SIZES.BASE * 2: 20,
    // paddingTop: iPhoneX ? theme.SIZES.BASE * 4 : theme.SIZES.BASE / 6,
    zIndex: 5,
    fontSize: 20,
  },
  shadow: {
